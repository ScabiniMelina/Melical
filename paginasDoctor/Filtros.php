    ...
    <div class="container pagina pt-3 ">
        ...
        <div class="row">
            <!-- <div class="col-5 col-md-12">  -->
                <ul class="nav nav-pills nav-tabs mb-3 card-header-pills card m-0 d-flex w-100 flex-wrap  flex-row nav-justified" id="pills-tab-seccion" role="tablist">
                    ...
                    <div class="tab-pane fade show active" id="pills-fecha" role="tabpanel" aria-labelledby="pills-fecha-tab">
                        <div class="row">
                            <div class="col-12 col-lg-6 pb-3">
                                ...
                                <input type="datetime-local" class="form-control form-control-sm" id="inputFechaInicioBusqueda" >
                            </div>
                            <div class="col-12 col-lg-6 pb-3 ">
                                <label for="inputFechaFinBusqueda" class="form-label form-label-sm">Fin de busqueda</label>
                                <input type="datetime-local" class="form-control form-control-sm" id="inputFechaFinBusqueda" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                        </div>
                    </div>
