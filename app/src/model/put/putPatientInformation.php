...
$sql = "SELECT COUNT(*) AS numberOfMatches FROM `Personal_Information` WHERE `cuil` = ? AND ID_DNI != ?";
$typeOfParameters = "is";
...
$sql = "UPDATE Personal_Information SET dni = ?, cuil= ? , name= ? , surname= ?, gender = ? , date_birth = ? , phone = ? , email = ? , adress = ? , adress_number = ? , PK_Location = ? WHERE ID_DNI = ?";
