        ...
        <div class="row h-100 align-content-between">
            ...
            <div class="col-12">
                <div class="container h-auto">
                    <h1 class="display-5 fuente-color-primary lead">Recupera tu contraseña</h1>
                    <h4 class="text-muted fs-5 lead">Introduce tu correo electrónico asociado a esta cuenta.</h4>
                    <form class="row g-3 pb-3 pt-4 needs-validation" novalidate>
                        <div class="col-12">
                            <label for="inputDni4" class="form-label">Correo electrónico</label>
                            <input type="email" name="email" required class="form-control">
                        </div>
                        <div class="col-12 justify-self-center text-sm-start">
                            <button class="btn btn-primary mt-3 text-align-center text-nowrap text-sm-center postInformation authentificationForm" type="submit" data-file="ResetPassword" data-redirect="./login.php" id="" role=" button">Continuar</button>
                        </div>
                    </form>
                </div>
            </div>
